...
export function BrowserMockup({ src, alt, width, height, label = "interviewkit.app", className = "", priority = false }: MockupProps & { label?: string }) {
  return (
...
export function CardMockup({ src, alt, width = 800, height = 600, className = "", priority = false }: MockupProps) {
  return (
